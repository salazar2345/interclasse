...
function Faseum() {
  return (
    <div className="App">
      ...
      <p style={{fontWeight:900, marginBottom:40}}>TENIS/MESA FEMININO E MASCULINO - GRUPO 2</p>
      <table>
  <tr>
    <th>BÉLGICA 9º B</th>
    <th>X</th>
...
<table>
  ...
  <tr>
    ...
    <th>ANGOLA 3º A</th>
      ...
      <div className='tabelas'>
      <div className="tabela">
      <p style={{fontWeight:900, marginBottom:40}}>SEMI FINAL TENIS/MESA</p>
      <table>
  ...
  <tr>
    ...
    <div className='tabela2'>
    <p style={{fontWeight:900, marginBottom:40}}>FINAL TENIS/MESA</p>
<table>
  <tr>
    <th>BÉLGICA 9º B</th>
    <th>X</th>
